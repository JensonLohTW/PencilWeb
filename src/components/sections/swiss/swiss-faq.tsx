    ...
    return (
        <section className="border-t border-pencil-200 px-6 py-24 lg:px-16 dark:border-white/10">
            ...
            <div className="mb-16 grid gap-8 lg:grid-cols-2">
                <div>
                    <p className="swiss-mono mb-2 text-pencil-500 dark:text-pencil-400">{t('pages.home.faq.eyebrow')}</p>
                    <h2 className="text-4xl font-bold tracking-tight text-pencil-950 lg:text-5xl dark:text-white">
                        {t('pages.home.faq.title')}
                    </h2>
                </div>
                <p className="max-w-md text-pencil-600 lg:ml-auto dark:text-pencil-400">{t('pages.home.faq.description')}</p>
            </div>
                        ...
                        >
                            ...
                            <AnimatePresence>
                                {openId === faqId && (
                                    ...
                                    >
                                        <p
                                            className="pb-6 pl-18 text-pencil-600 lg:pl-18 lg:pr-16 dark:text-pencil-400"
