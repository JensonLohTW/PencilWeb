    ...
    return (
        <section className="border-t border-pencil-200 px-6 py-24 lg:px-16 dark:border-white/10">
            ...
            <div className="relative">
                {/* Vertical Line */}
                <div className="absolute bottom-0 left-6 top-0 hidden w-px bg-pencil-200 lg:left-16 lg:block dark:bg-white/10" />
                ...
                <div className="space-y-0">
                    {timeline.map((item, index) => (
                        ...
                        >
                            ...
                            <div className="absolute left-12 top-8 z-10 hidden size-8 items-center justify-center border border-pencil-200 bg-pencil-50 transition-colors group-hover:border-cta group-hover:bg-cta lg:flex dark:border-white/20 dark:bg-pencil-900">
                            ...
                            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:gap-16">
                                ...
                                {/* Description */}
                                <p className="text-pencil-600 lg:ml-auto lg:max-w-md lg:text-right dark:text-pencil-400">{item.description}</p>
                            </div>
                        </motion.div>
                    ))}
                </div>
