    ...
    <section id="project-list" className="px-6 py-24 lg:px-16">
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="swiss-mono text-xs tracking-[0.16em] text-pencil-500 uppercase dark:text-pencil-400">
        ...
        <div className="mb-8 flex flex-wrap gap-3">
          {filterOptions.map((option) => (
            <button
              ...
              className={
                activeFilter === option
                  ? 'rounded-full border border-pencil-950 bg-pencil-950 px-4 py-2 text-xs font-semibold tracking-[0.16em] text-white uppercase dark:border-white dark:bg-white dark:text-pencil-950'
                  : 'rounded-full border border-pencil-300 px-4 py-2 text-xs font-semibold tracking-[0.16em] text-pencil-600 uppercase transition-colors hover:border-cta hover:text-cta dark:border-white/20 dark:text-pencil-300'
              }
            >
              {option}
            </button>
              ...
              <div className="grid gap-6 lg:grid-cols-[14rem_minmax(0,1fr)_15rem]">
                ...
                <div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-semibold tracking-tight text-pencil-950 dark:text-white">
                        {item.title}
                      </h3>
