...
export function PartnerLogos() {
  ...
  return (
    <div className="mx-auto mt-32 max-w-7xl sm:mt-40 sm:px-6 lg:px-8">
      <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl shadow-accent-500/10 duration-300 after:pointer-events-none after:absolute after:inset-0 after:ring-1 after:ring-white/10 after:ring-inset sm:rounded-3xl sm:px-16 after:sm:rounded-3xl dark:bg-gray-900 dark:shadow-accent-500/10">
        <FadeIn>
          <h2 className="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-white sm:text-4xl">{t('title')}</h2>
          <p className="mx-auto mt-6 max-w-xl text-lg/8 text-gray-300">{t('description')}</p>
        </FadeIn>
