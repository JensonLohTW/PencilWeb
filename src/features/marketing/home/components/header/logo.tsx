  ...
  return (
    <Link href="/" className={clsx('group flex min-w-0 items-center gap-4', className)} {...props}>
      ...
      <div className="flex min-w-0 flex-col">
        <span
          className={clsx(
            'font-bold tracking-tight whitespace-nowrap text-cta dark:text-white',
        ...
        {!compact && (
          <span className="swiss-mono text-[10px] whitespace-nowrap text-cta dark:text-pencil-500">{t('tagline')}</span>
        )}
      </div>
    </Link>
  )
