                  ...
                  <dd className="mt-4 flex flex-auto flex-col">
                    ...
                    <div className="mb-3 flex flex-wrap gap-1.5">
                      {SOLUTION_TAGS[index % SOLUTION_TAGS.length].map((tag) => (
                        <span
                          key={tag}
                          className="inline-flex rounded-full bg-accent-50 px-2 py-0.5 text-[10px] font-medium tracking-wide text-accent-700 dark:bg-accent-500/10 dark:text-accent-300"
                        >
                          {tag}
                        </span>
                      ))}
