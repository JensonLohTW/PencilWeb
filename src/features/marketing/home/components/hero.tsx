...
export function Hero() {
  ...
  return (
    <div className="relative isolate overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 pt-24 pb-24 sm:pt-32 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        <StaggerContainer className="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8" viewport={{ once: true, amount: 0.5 }}>
          <StaggerItem>
            <div className="flex items-center gap-x-2">
              <div className="rounded-md bg-accent-500/10 p-2 ring-1 ring-accent-500/20 ring-inset">
                <svg
          ...
          <StaggerItem>
            <KineticHeading
              as="h1"
              text={t('headline')}
              className="mt-10 text-5xl font-semibold tracking-tight break-keep text-gray-900 sm:text-7xl dark:text-white"
            />
          </StaggerItem>
          <StaggerItem>
