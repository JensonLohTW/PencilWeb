...
const getBentoClasses = (index: number) => {
  switch (index) {
    case 0:
      return 'lg:col-span-2 lg:row-span-2 md:col-span-2' // XR: Large square
    case 1:
      return 'lg:col-span-1 lg:row-span-2 md:col-span-1' // AI: Tall rectangle
    case 2:
      return 'lg:col-span-1 lg:row-span-1 md:col-span-1' // IoT: Small square
    case 3:
      return 'lg:col-span-1 lg:row-span-1 md:col-span-1' // 5G/6G: Small square
    case 4:
      return 'lg:col-span-2 lg:row-span-1 md:col-span-2' // Haptic: Wide rectangle
    case 5:
      return 'lg:col-span-2 lg:row-span-1 md:col-span-2' // Digital Twin: Wide rectangle
    default:
    ...
    <div className="overflow-hidden bg-pencil-50 py-24 sm:py-32 dark:bg-pencil-950">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <StaggerContainer
          ...
          className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:mt-20 md:grid-cols-2 lg:max-w-none lg:auto-rows-min lg:grid-cols-4 lg:items-start"
        >
          {Array.isArray(list) &&
                ...
                >
                  ...
                  <motion.div
                    ...
                    className={cn(
                      ...
                      isExpanded
                        ? 'shadow-2xl ring-1 shadow-accent-500/15 ring-accent-500/20'
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        'pointer-events-none absolute inset-0 bg-gradient-to-br from-accent-100/30 via-transparent to-transparent opacity-0 transition-opacity duration-700 dark:from-accent-500/10',
                    ...
                    <div className="relative z-10 flex flex-1 flex-col p-8 lg:p-10">
                        ...
                        <motion.div
                          ...
                          className={cn(
                            ...
                            isExpanded
                              ...
                              : 'bg-accent-100/50 text-accent-600 dark:bg-accent-500/10 dark:text-accent-400',
                          )}
                        >
                      ...
                      <div className="mt-auto">
                        <div className="flex items-center gap-3">
                          <span className="font-mono text-xs font-bold tracking-widest text-accent-500/60 uppercase dark:text-accent-400/50">
                            {feature.number}
                          </span>
                          <h3
                            className={cn(
                        ...
                        <p className="mt-4 text-base/7 text-pencil-600 dark:text-gray-400">{feature.subtitle}</p>
                      </div>
                      ...
                      <AnimatePresence initial={false}>
                        {isExpanded && (
                          ...
                          >
                            <div className="pt-6">
                              <div className="mb-6 h-px w-12 bg-accent-500/30" />
                              <motion.p
