...
export function SolutionsSocialProofSection({ socialProof }: SolutionsSocialProofSectionProps) {
  return (
    <section className="mx-auto mt-16 flex max-w-7xl justify-center px-6 lg:px-8">
      <p className="relative rounded-full bg-white/80 px-4 py-1.5 text-sm/6 text-pencil-600 inset-ring inset-ring-pencil-900/10 dark:bg-pencil-900/60 dark:text-pencil-300 dark:inset-ring-white/10">
